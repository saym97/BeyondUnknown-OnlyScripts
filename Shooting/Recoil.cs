...
public class Recoil : MonoBehaviour {
    ...
    [Header("Recoil_Transform_Camera")]
    public Transform CameraRecoilPositionTranform;
    public Transform CameraRecoilRotationTranform;
    [Space(10)]
    [Header("Recoil_Settings")]
    public float PositionDampTime;
    public float RotationDampTime;
    [Space(10)]
    public float CameraDampMultiplier;
    [Space(10)]
    ...
    public Vector3 CamRotationOutput;
    ...
    void FixedUpdate() {
        ...
        CameraRecoilPositionTranform.localPosition = Vector3.Slerp(CameraRecoilPositionTranform.localPosition, CurrentRecoil3 /3, PositionDampTime * CameraDampMultiplier * Time.fixedDeltaTime);
        CamRotationOutput = Vector3.Slerp(RotationOutput, CurrentRecoil1 /4 , RotationDampTime * CameraDampMultiplier * Time.fixedDeltaTime);
        CameraRecoilRotationTranform.localRotation = Quaternion.Euler(CamRotationOutput);
    }
    public void Fire() {
